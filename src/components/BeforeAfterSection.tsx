...
const API_URL =
  "https://payload-cms-ai-booking.vercel.app/api/beforeAfter/1?depth=2&draft=false";
...
const BeforeAfterSection = () => {
  ...
  useEffect(() => {
    fetch(API_URL)
      ...
      .then((json) => {
        if (json && json.beforeItems && json.afterItems && json.roiStats) {
          setData(json);
        } else {
          setError("Missing required before/after data");
        }
      })
  ...
  if (loading) return <div>Loading before/after section...</div>;
...
//             <span className="inline-flex animate-text-gradient bg-gradient-to-r from-[#9487FC] via-[#6E4DF2] to-[#c7d2fe] bg-[200%_auto] bg-clip-text text-transparent">
//               {" "}
//               l'intégration de notre IA
//             </span>
//           </h2>
//           <p className="text-xl text-gray-300 max-w-3xl mx-auto">
//             Découvrez la transformation radicale de votre quotidien
//             professionnel
//           </p>
//         </div>
