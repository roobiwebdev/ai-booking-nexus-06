              ...
              {data.socialLinks.map(({ platform, url }, i) => {
                ...
                return (
                  <a
                    ...
                    className="w-9 h-9 bg-[#6645E8]/20 rounded-lg flex items-center justify-center hover:bg-[#6645E8]/40 transition-colors"
                  >
                    <Icon className="w-4 h-4 text-[#6645E8]" />
                  </a>
                );
              })}
            </div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              {data.solutionLinks.map(({ label, url }, i) => (
                <li key={i}>
                  <a
                    href={url}
                    className="hover:text-[#6645E8] transition-colors"
                  >
                    {label}
                  </a>
                </li>
