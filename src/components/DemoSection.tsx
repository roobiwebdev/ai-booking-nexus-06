...
<span className="relative inline-block overflow-hidden rounded-full p-[1px]">
              ...
              <div className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-gray-950 px-4 sm:px-8 py-2 text-md sm:text-lg font-medium text-gray-50 backdrop-blur-3xl ">
              Tester l'outil en démo personnalisée
